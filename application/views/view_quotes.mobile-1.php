...
<div id="slider" class="clearfix">
	<div class="slide first" id="slide-4">
...
<div id="move-details">
	<div class="moving-from">
		<div class="heading">Moving From:</div>
		<div class="clearfix from-info">
			<div class="display">
				<span class="info">Santa Monica, CA 90401</span>
				<div class="edit-btn">Edit</div>
			</div>
			<div class="editable clearfix">
				<input type="text" name="from_zip" value="" maxlength="5">
				<div id="zip-help-icon"></div>
				<div class="update-btn">UPDATE</div>
			</div>
		</div>
	</div>
	<div class="moving-to">
		<div class="heading">Moving To:</div>
		<div class="from-info clearfix">
			<div class="display">
				<span class="info">Portland, OR 97201</span>
				<div class="edit-btn">Edit</div>
			</div>
			<div class="editable clearfix">
				<input type="text" name="to_zip" value="" maxlength="5">
				<div id="zip-help-icon"></div>
				<div class="update-btn">UPDATE</div>
			</div>
		</div>
	...
	<div class="moving-date">
		<div class="heading">Moving Date:</div>
		<div class="from-info clearfix">
			<div class="display">
				<span class="info">12/27/2016</span>
				
				<div class="edit-btn">Edit</div>
			</div>
			<div class="editable">
			<input type="text" name="move_date" value="">
			</div>
		</div>
	</div>
	<div class="moving-size">
		<div class="heading">Moving Size:</div>
		<div class="from-info clearfix">
			<div class="display">
			...
			<div class="editable">
				<select name="move_size">
					<option value="">Move Size</option><option value="moving boxes only">Moving Boxes Only</option><option value="studio">Studio</option><option value="one bedrooms apartment">1 Bedroom Apt</option><option value="one bedrooms house">1 Bedroom House</option><option value="two bedrooms apartment">2 Bedroom Apt</option><option value="two bedrooms house">2 Bedroom House</option><option value="three bedrooms apartment">3 Bedroom Apt</option><option value="three bedrooms house">3 Bedroom House</option><option value="four bedrooms apartment">4 Bedroom Apt</option><option value="four bedrooms house">4 Bedroom House</option><option value="five bedrooms apartment">5 Bedroom Apt</option><option value="five bedrooms house">5 Bedroom House</option><option value="six bedrooms apartment">6 Bedroom Apt</option><option value="six bedrooms house">6 Bedroom House</option><option value="six bedrooms and more apartment">6 or more Bedroom Apt</option><option value="six bedrooms and more house">6 or more Bedroom House</option>
				</select>
			</div>
		</div>
	</div>
