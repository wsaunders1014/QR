...
<div id="slider" class="clearfix">
	<div class="slide first" id="slide-1">
		...
		<h3>The quickest way to get a quote on your move.</h3>
		<div class='form-box'>
			<div class="error-msg"><div class="icon"></div>Must be a US zipcode.</div>
			<div class="question" id="cityState">I'm moving from</div>
			<form id="moving_from-form">
				<input type="tel" name="zip_from" id="from_zip" autocomplete="off" placeholder="90405" maxlength="5" value="<?=$this->zip_from?>" tabindex="-1">
	...
	<div class="slide" id="slide-2">
		<div id="info-bar" class="clearfix">
			<div>
				<span style=""></span><span class="from-city"></span>
			</div>
			<div class="slash"></div>
			<div><span class="move-size"></span></div>
			<div class="slash"></div>
			<div><span class="move-date"></span></div>
		</div>
		<div class="form-box">
			<div class="question">I'm moving to</div>
			<form id="moving_to-form">
				<input type="text" class="ziphelp" name="zip_to" id="to_zip" autocomplete="off" placeholder="41404" value="<?=$this->zip_to?>" tabindex="-1">
				<div class="btn" id="to-loader">GO</div>
				<div class="results">
					<ul></ul>
				</div>
			</form>
	...
	<div class="slide" id="slide-4">
		...
		<div class="truck">
			<img src="../assets/img/mobile/truck-1.png">
		</div>
		<div id="disclaimer">
...
<div id="truck">
	<img style="opacity:1" src="../assets/img/mobile/truck-1.png">
	<img src="../assets/img/mobile/truck-2.png">
	<img src="../assets/img/mobile/truck-3.png">
	<img src="../assets/img/mobile/truck-4.png">
	<img src="../assets/img/mobile/truck-5.png">
</div>
<div id="overlay">
	<div id="ziphelp">
		<h3>ZIP Help</h3>
	...
	<div id="loader">
		...
		<h4>Calculating Cost... <span id="percent">43%</span></h4>
	</div>
