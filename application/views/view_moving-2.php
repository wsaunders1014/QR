<div id="content">
	<div id="main">
		...
		<div class="centered">
			...
			<div id="next-steps">
				<div id="one"><span class="checkmark"></span> Movers Found</div>
				<div id="arrow"></div>
				<div id="two"><span class="checkmark"></span>View Quotes</div>
			</div>
			...
			<!-- <div class="page" id="step-4">
				<form>
					...
					<div class="text-holder">
						<div id="blue-text">Calculating Cost<span id="dots">...</span></div>
					</div>
						<div id="reasons">
							<h3>The QuoteRunner Philosophy</h3>
							<div class="step step-1">
								<div class="icon"></div>
								<div>
									<div class="bold">Never Hurt Your Back Again</div>
									<div>Our movers are trained in the art of the perfect pickup so you’ll never have to risk your back again.
									</div>
								</div>
							</div>
							<div class="step step-2">
								<div class="icon"></div>
								<div>
									<div class="bold">Save Time, Money, and Energy</div>
									<div>Don’t miss time at work and save money on Gas, Tolls, 
										Food, and more when you let us do the heavy lifting.
									</div>
								</div>
							</div>
							<div class="step step-3">
								<div class="icon"></div>
								<div>
									<div class="bold">Rest Easy knowing you’re in Good Hands</div>
									<div>Your entire move is insured and taken care of by liscensed
				 						movers so you can take one thing off your mind.
									</div>
								</div>
							</div>
						</div>
			...
			<div class="page" id="step-5">
				<form class="clearfix">
					...
					<div class="input-container">
						...
						<input type="text" name="email" id="email" placeholder="Enter Email" autocomplete="off" maxlength="60">
