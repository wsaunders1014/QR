...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAOAFjKE8xQUWxlVds1COiroKVmYjH8SoM"></script> -->
    ...
    <header>
        <div class="container">
            ...
            <div class="col-xs-12 logo">
                <a href="#"  title="Quoterrunner.co">
                    <img src="<?php echo base_url().'assets/img/qr-logo.png';?>" alt="quoterrunner logo">
                </a>
            </div>
           </div>
