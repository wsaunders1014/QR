...
<div id="slider" class="clearfix">
	...
	<div class="slide" id="slide-2">
		<!-- <div id="info-bar">
			<div class="from-zip">90401</div>
			 <div class="slash"></div>
			<div class="move-size">4+ BR</div>
			 <div class="slash"></div>
			<div class="move-date">Nov 24</div>
		</div> -->
		<div class="form-box">
		...
		<div id="form-slider" class="clearfix">
			<div class="form-box">
				...
				<form id="email-form">
					...
					<div class="btn" id="to-name">GO</div>
				</form>
			</div>
			<div class="form-box">
	...
	<div class="slide" id="slide-7">
		...
		<div class="imover">
			<div class="content clearfix">
				<div class="icon" id="branchlogolink"></div>
				<div class="right">
					<h6>Want to Connect <br/>With Your Movers?</h6>
					<p>Speak directly with your movers and share your home inventory with the iMover app.</p>
				</div>
			</div>
                    <div class="btn" id="get-imover"><a id="branchlink" href="#">GET iMOVER</a></div>
		</div>
	</div>
</div>
<div id="overlay">
	...
	<div id="move-size">
		...
		<div id="size-list">
			<div class="size-btn" data-value="studio">STUDIO</div>
			<div class="size-btn" data-value="one bedrooms apartment">1 BEDROOM</div>
			<div class="size-btn" data-value="two bedrooms apartment">2 BEDROOM</div>
			<div class="size-btn" data-value="three bedrooms house">3 BEDROOM</div>
			<div class="size-btn" data-value="four bedrooms house">4+ BEDROOM</div>
			<div class="size-btn" data-value="two bedrooms house">OFFICE/COMMERCIAL</div>
		</div>
	</div>
	<div id="move-date">
